...
class AddNewAssetNew extends StatefulWidget {
  ...
  AddNewAssetNew(this.selectedCategory,this.itemsList, this.assetItems,this.editAsset, {super.key});

  @override
  State<AddNewAssetNew> createState() => _AddNewAssetNewState();
}

class _AddNewAssetNewState extends State<AddNewAssetNew> {
...
if(widget.itemsList!=null) {
  ...
  if (widget.editAsset == null) {
    addAssetData.item = widget.assetItems!.id;
    addAssetData.itemForm = widget.assetItems!.formdata;
    addAssetData.itemName = widget.assetItems!.item;
  }
}else{
  // _getallitems();
}
  ...
  _getallitems() async {
    ...
    GetAssetItems response =
        await   appController.getAssetByCategory(
            login_user!.id,
    ...
    if(itemlist.isEmpty) {
      ...
      return Container(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              centerTitle: false,
              title: Text(
                "Add ${(widget.selectedCategory != null) ? widget
            ...
            body: Container(
                margin: EdgeInsets.all(12), child:  const Center(
      ...
      return Container(
          ...
          child: Scaffold(
            ...
            body: Container(
                margin: EdgeInsets.all(12), child: buildProfileUI()),
          ));
    }
  }
    ...
    return SingleChildScrollView(
        child: Column(
          children: [
            ...
            (isshowcategory)
                ?  _getLabel("Sub Category", "YES"): Container(),
            (isshowcategory)
                ?   Container(
                height: 44,
                child: DropdownSearch<String>(
