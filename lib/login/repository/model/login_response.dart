...
import '../../../assetmana/data/local/preference_keys.dart';
...
class LoginData {
  ...
  static Future<LoginData> getSavedUser() async {
    String? userString = await AppSharedPrefs.get().getValue(PreferenceKeys.USER_DATA);
